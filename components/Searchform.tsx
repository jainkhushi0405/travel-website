  ...
  return (
    <div className="bg-white shadow-lg rounded-3xl p-8 max-w-[1232px] mx-auto -mt-20 relative z-10">
      ...
      <div className="flex gap-2 items-end">
        ...
        {/* TRIP */}
        <div ref={dropdownRef} className="relative w-[206px]">
          <label className="text-xs text-gray-500 bg-white px-1 absolute -top-2 left-3">
            Trip
          </label>
          ...
          >
            ...
            <Image src="/chevron-down.svg" alt="Dropdown" width={14} height={7} />
          </button>

          {showDropdown && (
            <div className="absolute top-[62px] left-1/2 -translate-x-1/2 z-50 w-[140px] h-[150px] bg-white rounded-[15px] border border-black/10 shadow-md overflow-hidden">
              ...
              <button
                ...
                className="w-full h-[49px] flex items-center justify-center text-sm font-semibold text-gray-900"
              >
                One Way
              </button>
              ...
              <button
                ...
                className="w-full h-[48px] flex items-center justify-center text-sm font-semibold text-gray-900"
              >
                Multicity
              </button>
